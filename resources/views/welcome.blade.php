...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('cirm/img/logo2.png')}}">
    <script src="https://kit.fontawesome.com/yourcode.js" crossorigin="anonymous"></script>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/css/all.min.css">
    <link rel="stylesheet" href="{{asset('cirm/style.css')}}">
...
<body>
    <header>
        <div class="logo">
            <img src="{{asset('cirm/img/logo.png')}}">
        </div>
        <div class="titre1">
